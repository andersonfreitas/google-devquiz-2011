...
puts "There are #{text_preps(text_b)} prepositions in Text B."
puts
puts "### Question 2 ###"
puts "There are #{verbs(text_a)[0]} verbs in Text A. (76)"
puts "There are #{verbs(text_b)[0]} verbs in Text B."
puts
puts "### Question 3 ###"
puts "There are #{verbs(text_a)[1]} subjunctive verbs in Text A. (58)"
puts "There are #{verbs(text_b)[1]} subjunctive verbs in Text B."
puts
puts "### Question 4 ###"
